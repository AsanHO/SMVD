...
const About1 = () => {
  ...
  <Desktop>
    <Container>
      <Box style={{position:"relative"}}>
          ...
          <img src="ABOUT_graphic_1.png" style={{position:"absolute",float:"right", marginLeft:"60%", marginTop:"10%",width:"55%", zIndex:"-1"}}></img>
          <IntroGrid>
      ...
      <GrayPart>
        ...
        <Box style={{position:"relative"}}>
          ...
          <div style={{textAlign:"center", width:"50%", fontSize:"12pt", marginLeft:"25%", lineHeight:"25pt", marginBottom:"8%"}}>
          ...
          <div style={{width:"70%", textAlign:"center", marginLeft:"15%", marginBottom:"10%",fontSize:"12pt"}}>
          <span style={{fontWeight:"bold", marginRight:"2%"}}>졸업전시 위원장</span> <span style={{marginRight:"4%"}}>장민혁</span>   
          <span style={{fontWeight:"bold", marginRight:"2%"}}>졸업전시 부위원장</span> <span style={{marginRight:"4%"}}>노정은</span>    
          <span style={{fontWeight:"bold", marginRight:"2%"}}>총무&서기</span> <span style={{marginRight:"4%"}}>강다혜 심우재</span> 
          </div>
          ...
          <NtGrid>
            <div style={{gridColumn:"1", alignContent:"center", maxWidth:"50%", marginLeft:"25%"}}>
  ...
  <Mobile>
    ...
    <Box style={{position:"relative"}}>
        <img src="logocolor.png" style={Logoimg}></img><br></br>
        <img src="ABOUT_graphic_1.png" style={{position:"absolute",float:"right", marginLeft:"60%", width:"55%", zIndex:"-1"}}></img>
        <MIntroGrid>
          <div style={{gridColumn:"1", gridRow:"1"}}>
            *빛의 성분을 파장의 순서로 나열한 것<br></br>
            *빛을 각 성분으로 나누는 것을 '스펙트럼으로 분해한다'라고 표현
    ...
    <GrayPart>
      ...
      <OGrid>
      <div style={{gridColum:"1", fontSize:"9pt", lineHeight:"20pt"}}>
        하나의 빛이 끊임없이 연결하여 다채로운 빛으로 나타내듯이 스펙트럼의 연결성을 상징적으로 나타내어 표현하였습니다.
      </div>
      <div style={{gridColumn:"2", fontSize:"9pt", lineHeight:"20pt"}}>
        It symbolically represents the connectivity of the spectrum, 
        as one light is constantly connected and represented by colorful light.
      </div>
      </OGrid>
      ...
      <Box>
        ...
        <MOGrid>
        <div style={{gridColumn:"1", overflow:"hidden", fontSize:"9pt", lineHeight:"20pt"}}>
          스펙트럼의 연속됨과 로고의 형태를 응용하여 제작하였습니다. 배경 컬러는 
          다채로움과 배움의 성장을 밝은 컬러의 그라데이션으로 표현하였습니다. 
          그래픽 의미는 라인과 면으로 우리들의 다양성을 나타내었고 흐르는 듯한 반복성으로 여러 디자인 분야로 흘러 진출한다는 의미를 담았습니다.
        </div>
      ...
      <Box style={{position:"relative"}}>
        ...
        <div style={{textAlign:"center", width:"60%", fontSize:"8pt", marginLeft:"20%", lineHeight:"20pt", marginBottom:"8%"}}>
          제12회 졸업준비 위원회는 SPECTRUM의 전반적인 기획과 운영을 위해 모인 위원회로서, 총 47명의 
          학생들로 구성되어 있습니다. 졸업준비 위원회를 중심으로 모든 구성원들이 하나가 되어 SPECTRUM의 
          다채로운 연결성을 위해 끊임없이 노력하고 있습니다. 함께를 통해 배우고 성장하며, 다양한 디자인을 제작합니다
        </div>
        <div style={{width:"70%", textAlign:"center", marginLeft:"15%", marginBottom:"10%",fontSize:"19pt"}}>
        <span style={{fontWeight:"bold", marginRight:"2%", fontSize:"9pt"}}>졸업전시 위원장</span> <span style={{marginRight:"4%", fontSize:"9pt"}}>장민혁</span>    
        <span style={{fontWeight:"bold", marginRight:"2%", fontSize:"9pt"}}>졸업전시 부위원장</span> <span style={{marginRight:"4%", fontSize:"9pt"}}>노정은</span>       
        <span style={{fontWeight:"bold", marginRight:"2%", fontSize:"9pt"}}>총무&서기</span> <span style={{marginRight:"4%", fontSize:"9pt"}}> 강다혜 심우재 </span>
        </div>
        <img src="ABOUT_right_graphic_3.png" style={{position:"absolute", marginLeft:"45%", width:"90%", float:"right", overflow:"hidden"}}></img>
        <NGrid style={{position:"relative"}}>
          <div style={{gridColumn:"1"}}>
            <p style={Mdnstyle}>기획팀</p>
            <p style={Mnsstyle}>김수연 | 곽승연 김세헌 김유림 김혜원 이태윤 이영주 최지은</p>
          </div>
          <line style={{position:"absolute", borderRight:"solid 30px 1px black"}}></line>
          <div style={{gridColumn:"2"}}>
            <p style={Mdnstyle}>디자인팀</p> 
            <p style={Mnsstyle}>추채원 | 김수빈 김하영 남민재 모하마디 모가담 
            록사나 신지수 심보레미 엄혜민 야오다 럭키 유연아 
            응웬반티엔 장문정 전정배 최가연 팜티탄로안
            </p>
          </div>
          <div style={{gridColumn:"3"}}>
            ...
            <p style={Mnsstyle}>윤은영 | 곽연우 김정희 박지윤 박청  유라현 응옌홍후 최유정 카와사키 키미코 
            </p>
          </div>
        </NGrid>
        <NtGrid>
